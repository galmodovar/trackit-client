...
export const Register = () => {
    ...
    const handleRegister = (e) => {
        ...
        if (password.current.value === verifyPassword.current.value) {
            ...
            return fetch("https://trackit-server-side.herokuapp.com/register", {
                method: "POST",
                headers: {
        ...
        <main style={{ textAlign: "center" }}>
            ...
            <form className="form--login" onSubmit={handleRegister}>
                ...
                <fieldset>
                    ...
                    <textarea ref={occupation} name="occupation" className="form-control" placeholder="Let us know what you do for a living..." />
                </fieldset>
                <fieldset>
